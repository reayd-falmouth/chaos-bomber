...
local UITheme = require("ui_theme")  -- Import shared colors
...
function MainMenu.keypressed(key)
    ...
    elseif key == "return" or key == "kpenter" then
        local item = menuItems[selectedIndex]
        print("Selected item:", item.label, "Value:", item.value)
        print("Starting game...")
        switchState(require("scenes.game")) -- Switch to game state
    end
end
