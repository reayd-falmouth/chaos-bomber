...
enum class PartyOption : uint32_t
{
    ...
    /// <para>
    /// Direct peer connectivity is supported for the Windows, Microsoft Game Core, PlayStation®, Switch, Linux, and
...
public:
    ...
    /// </para>
    /// <para>
    /// For a list of supported format options for PlayStation® 5, please refer to the
...
public:
    ...
    /// <see cref="Initialize()" /> and takes effect immediately. <b>On PlayStation®, attempting to set the processor
