...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Layer mask used for post-move obstruction checks.
        /// Ghost sets CharacterController.excludeLayers; we invert that so Ghost-excluded layers
        /// don't affect the obstruction/correction capsule cast.
        /// </summary>
        private int GetObstructionLayerMask()
        {
            if (m_Controller == null)
                return -1;
            return ~m_Controller.excludeLayers;
        }
        ...
        void Awake()
        {
            ...
            // Cache dependencies here so Health.OnDie is subscribed even when this component
            // never reaches Start() (e.g. disabled in Bomberman mode before first Start frame).
